...
classifier = MLPClassifier(
    ...
    max_iter=200, # the number of epochs (how many times each data point will be used), not the number of gradient steps.
    random_state=1,
    verbose=10
)
